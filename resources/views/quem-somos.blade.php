            ...
            <div class="story-content">
                ...
                <div class="story-text">
                    ...
                    <p class="story-description">
                        Somos uma plataforma dedicada à paixão pelo cinema! Nossa missão é tornar sua experiência única,
                        confortável e envolvente, desde a escolha do filme até o último segundo da sessão.
                    </p>
                    <p class="story-description">
                        Com tecnologia de ponta, ambiente confortável e uma equipe apaixonada, transformamos cada visita em
                        uma experiência cinematográfica inesquecível. Aqui, o cinema não é apenas entretenimento – é uma
                        jornada sensorial completa.
                    </p>
            ...
            <div class="values-grid">
                <div class="value-card">
                    ...
                    <p class="value-description">
                        Oferecer uma experiência cinematográfica moderna, prática e acessível para todos os públicos,
                        democratizando o acesso à cultura e ao entretenimento de qualidade.
                    </p>
                ...
                <div class="value-card featured">
                    ...
                    <p class="value-description">
                        Ser referência nacional em inovação e tecnologia para agendamentos de sessões de cinema, sempre
                        pioneiros em soluções que facilitam a vida dos cinéfilos.
                    </p>
                ...
                <div class="value-card">
                    ...
                    <p class="value-description">
                        Compromisso com a excelência, respeito ao cliente, inovação constante, ética em todas as relações e,
                        acima de tudo, paixão genuína pelo cinema.
                    </p>
            ...
            <div class="team-grid">
                <article class="team-card">
                    <div class="team-image-wrapper">
                        ...
                        <div class="team-overlay">
                            <div class="social-links">
                                <a href="https://www.linkedin.com/in/kaua-amorim" target="_blank" class="social-link"
                                    aria-label="LinkedIn">
                                    <i class="fab fa-linkedin-in"></i>
                                </a>
                                <a href="https://github.com/kauaamorim" target="_blank" class="social-link"
                                    aria-label="GitHub">
                    ...
                    <div class="team-info">
                        ...
                        <img src="{{ asset('img/kaua.png') }}" alt="Kauã Amorim">
                ...
                <article class="team-card featured-member">
                    ...
                    <div class="team-image-wrapper">
                        ...
                        <div class="team-overlay">
                            <div class="social-links">
                                <a href="https://www.linkedin.com/in/gabriel-arruda" target="_blank" class="social-link"
                                    aria-label="LinkedIn">
                                    <i class="fab fa-linkedin-in"></i>
                                </a>
                                <a href="https://github.com/gabrielarruda" target="_blank" class="social-link"
                                    aria-label="GitHub">
                                    <i class="fab fa-github"></i>
                                </a>
                    ...
                    <div class="team-info">
                        ...
                        <img src="{{ asset('img/arruda.png') }}" alt="Gabriel Arruda">
                        <p class="team-description">
                            Especialista em desenvolvimento completo, responsável pela arquitetura e implementação do
                            sistema.
                        </p>
                        <div class="team-skills">
                ...
                <article class="team-card">
                    <div class="team-image-wrapper">
                        ...
                        <div class="team-overlay">
                            <div class="social-links">
                                <a href="https://www.linkedin.com/in/lucas-dev" target="_blank" class="social-link"
                                    aria-label="LinkedIn">
                                    <i class="fab fa-linkedin-in"></i>
                                </a>
                                <a href="https://github.com/lucasdev" target="_blank" class="social-link"
                                    aria-label="GitHub">
                                    <i class="fab fa-github"></i>
                                </a>
        ...
        <div class="container">
            <div class="cta-content">
                ...
                <div class="cta-actions">
                    <a href="{{ route('filme-em-cartaz') }}" class="cta-button primary">
                        <i class="fas fa-film"></i>
                        Ver Filmes
                    </a>
